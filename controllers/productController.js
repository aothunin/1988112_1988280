let controller = {};
// const { idleTimeoutMillis, query_timeout } = require('pg/lib/defaults');
let models = require('../models');
let Product = models.Product;
let Sequelize = require('sequelize');
let Op = Sequelize.Op; //Op là Operation
...
controller.getAll = (query) => {
    return new Promise((resolve, reject) => {
        ...
        // đang làm việc trên bảng Products
                attributes: [],
        ...
        Product
                    ...
                    include: [{ model: models.User },
                        {
                            ...
                            as: 'SubComments',
                            include: [{ model: models.User }]
                // include ở đây để lấy thông tin user của subcomment
                        }
                    ]
                });
            })
            .then(comments => {
                ...
                return models.Review.findAll({
                    where: { productId: id},
            // mỗi Review là của 1 người dùng nên phải include user
                    include: [{ model: models.User }]
                });
            })
            .then(reviews => {
